...
export const AgregarEmpleados = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post("https://api-server-r60vmqlij-rennitos-projects.vercel.app/empleados", data);
  ...
  const getNextId = async () => {
    try {
      const response = await axios.get("https://api-server-r60vmqlij-rennitos-projects.vercel.app/empleados");
